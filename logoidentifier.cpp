...
int main()
{
	...
	Mat img = imread("/home/triveninaik/comp_inter/trademarkVision/logo_spotting_problem/test/porsche_4.jpg", 1);
	Mat imgGray;
	imgGray = preProcessImage(img);
	
	/// read template image and preprocess it
	Mat logo;
	logo = imread("/home/triveninaik/comp_inter/trademarkVision/logo_spotting_problem/logos/porsche.png", 1);
	Mat logoGray;
